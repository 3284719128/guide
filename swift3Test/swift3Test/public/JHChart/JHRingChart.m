...
//        _redius = (CGRectGetHeight(self.frame) -60*k_Width_Scale)/4;
        _redius = CGRectGetHeight(self.frame)/2 - 28/2;
...
- (void)setColorDataArr:(NSArray *)colorDataArr {
    _colorDataArr = colorDataArr;
}
...
//        layer.strokeColor =[k_COLOR_STOCK[i] CGColor];
        ...
        layer.strokeColor =[_colorDataArr[i] CGColor];

...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL ret = [_mapManager start:@"NyqM9xrjpWrWBntthSSFge7aufwr64CB" generalDelegate:self];
...
//    }
    ...
    reverseGeoCodeSearchOption.reverseGeoPoint = _currentUserLocationCoordinate;
